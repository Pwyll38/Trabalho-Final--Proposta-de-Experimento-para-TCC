...
Objetivo: realizar um planejamento de experimento de um tema escolhido para TCC.
...
Seguiras as orientações dadas em sala de aula.

Abaixo estão as informações que o seu trabalho deverá produzir.
